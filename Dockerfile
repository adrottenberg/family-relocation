...
COPY tests/FamilyRelocation.API.Tests/FamilyRelocation.API.Tests.csproj tests/FamilyRelocation.API.Tests/
COPY tests/FamilyRelocation.Domain.Tests/FamilyRelocation.Domain.Tests.csproj tests/FamilyRelocation.Domain.Tests/
COPY tests/FamilyRelocation.IntegrationTests/FamilyRelocation.IntegrationTests.csproj tests/FamilyRelocation.IntegrationTests/
