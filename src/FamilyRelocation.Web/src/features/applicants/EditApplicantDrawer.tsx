import { Drawer, Form, Input, Select, Button, Space, Collapse, message, InputNumber } from 'antd';
        ...
        <Collapse defaultActiveKey={['husband', 'wife']} ghost>
          ...
          <Panel header="Current Address" key="address">
            ...
            <Space style={{ width: '100%' }}>
              <Form.Item name={['address', 'city']} label="City" style={{ flex: 2 }}>
                <Input />
              </Form.Item>

              <Form.Item name={['address', 'state']} label="State" style={{ flex: 1 }}>
                <Select options={US_STATES} showSearch />
              </Form.Item>

              <Form.Item name={['address', 'zipCode']} label="ZIP Code" style={{ flex: 1 }}>
                <Input />
              </Form.Item>
            </Space>
          </Panel>
